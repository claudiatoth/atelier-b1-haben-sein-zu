    ...
    ex1Data.forEach((it, i) => {
        html += `<div class="exercise-item">
            ...
            <div class="input-group">
                ...
                <input type="text" id="ex1-${it.id}" placeholder="habe / hast / hat / haben...">
            </div>
    ...
    ex2Data.forEach((it, i) => {
        html += `<div class="exercise-item">
            ...
            <div class="input-group">
                <label>${it.sentence}</label>
                <small style="color:#5A5147">💬 ${it.translation}</small>
                <input type="text" id="ex2-${it.id}" placeholder="ist / sind">
            </div>
    ...
    ex3Data.forEach((it, i) => {
        html += `<div class="exercise-item">
            ...
            <div class="input-group">
                <label>${it.sentence}</label>
                <small style="color:#5A5147">💬 ${it.translation}</small>
                <input type="text" id="ex3-${it.id}" placeholder="infinitiv cu zu...">
            </div>

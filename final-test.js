// ============================================
// TEST FINAL - Atelier B1: haben/sein + zu + Infinitiv
// Claudia Toth · 15 întrebări: haben+zu + sein+zu + zu la separabile + transformări + traducere
// ============================================

const finalTestData = [
    // haben + zu (3)
    { type: 'multiple', category: '🔵 haben+zu', question: '„haben + zu + Infinitiv" exprimă:', options: ['obligație activă (≈ müssen)', 'posibilitate pasivă', 'o acțiune din trecut', 'un viitor'], correct: 'obligație activă (≈ müssen)', explanation: 'haben + zu = TU trebuie activ să faci ceva (Ich habe viel zu tun = Ich muss viel tun).' },
    { type: 'luckentext', category: '🔵 haben+zu', question: 'Completează (haben):', sentence: 'Ich <strong>______</strong> heute viel zu erledigen.', translation: 'Azi am multe de rezolvat.', accept: ['habe'], correct: 'habe', explanation: 'ich habe + … + zu erledigen.' },
    { type: 'multiple', category: '🔵 haben+zu', question: '„Ich habe zu arbeiten" înseamnă:', options: ['Trebuie să muncesc', 'Am muncit', 'Aș munci', 'Pot să muncesc'], correct: 'Trebuie să muncesc', explanation: 'haben + zu ≈ müssen (obligație activă).' },

    // sein + zu (4)
    { type: 'multiple', category: '🟢 sein+zu', question: '„sein + zu + Infinitiv" are sens:', options: ['pasiv (≈ können/müssen + Passiv)', 'activ', 'reciproc', 'de trecut'], correct: 'pasiv (≈ können/müssen + Passiv)', explanation: 'sein + zu = lucrului i se face ceva (Das ist zu machen = muss/kann gemacht werden).' },
    { type: 'luckentext', category: '🟢 sein+zu', question: 'Completează (sein):', sentence: 'Das Formular <strong>______</strong> auszufüllen.', translation: 'Formularul trebuie completat.', accept: ['ist'], correct: 'ist', explanation: 'Das Formular (sg.) → ist + zu-Infinitiv.' },
    { type: 'luckentext', category: '🟢 sein+zu', question: 'Completează (sein, Plural!):', sentence: 'Die Regeln <strong>______</strong> zu beachten.', translation: 'Regulile trebuie respectate.', accept: ['sind'], correct: 'sind', explanation: 'Die Regeln (plural) → sind.' },
    { type: 'multiple', category: '🟢 sein+zu', question: '„Der Fehler ist leicht zu finden" înseamnă:', options: ['Greșeala poate fi găsită ușor', 'Greșeala găsește', 'Greșeala a fost mare', 'Trebuie să greșești'], correct: 'Greșeala poate fi găsită ușor', explanation: 'sein + zu cu „leicht" = posibilitate (≈ kann gefunden werden).' },

    // zu la separabile (3)
    { type: 'multiple', category: '🔧 zu separabile', question: 'La verbele separabile, „zu" stă:', options: ['între prefix și verb (auszufüllen)', 'înainte de verb', 'la finalul propoziției', 'lipsește'], correct: 'între prefix și verb (auszufüllen)', explanation: 'ausfüllen → aus-zu-füllen; abholen → ab-zu-holen.' },
    { type: 'luckentext', category: '🔧 zu separabile', question: 'Completează (ausfüllen + zu):', sentence: 'Das Formular ist <strong>______</strong>.', translation: 'Formularul trebuie completat.', accept: ['auszufüllen', 'auszufuellen'], correct: 'auszufüllen', explanation: 'separabil: aus + zu + füllen = auszufüllen.' },
    { type: 'luckentext', category: '🔧 zu separabile', question: 'Completează (abholen + zu):', sentence: 'Das Paket ist <strong>______</strong>.', translation: 'Pachetul trebuie ridicat.', accept: ['abzuholen'], correct: 'abzuholen', explanation: 'separabil: ab + zu + holen = abzuholen.' },

    // Transformări müssen (3)
    { type: 'multiple', category: '🔄 Transformări', question: '„Ich muss die Arbeit machen" (activ) = :', options: ['Ich habe die Arbeit zu machen', 'Ich bin die Arbeit zu machen', 'Ich habe die Arbeit gemacht', 'Ich werde die Arbeit machen'], correct: 'Ich habe die Arbeit zu machen', explanation: 'Subiect care acționează → haben + zu.' },
    { type: 'multiple', category: '🔄 Transformări', question: '„Die Arbeit muss gemacht werden" (Passiv) = :', options: ['Die Arbeit ist zu machen', 'Die Arbeit hat zu machen', 'Die Arbeit macht zu', 'Die Arbeit war gemacht'], correct: 'Die Arbeit ist zu machen', explanation: 'Passiv (lucrului i se face) → sein + zu.' },
    { type: 'luckentext', category: '🔄 Transformări', question: 'Completează (Passiv → sein zu):', sentence: 'Die Rechnung muss bezahlt werden. → Die Rechnung <strong>______</strong> zu bezahlen.', translation: 'Factura trebuie plătită.', accept: ['ist'], correct: 'ist', explanation: 'muss bezahlt werden → ist zu bezahlen.' },

    // Traducere (2)
    { type: 'translate', category: '🇷🇴 Traducere', question: 'Traduceți (haben zu):', ro: 'Azi am multe de rezolvat.', accept: ['ich habe heute viel zu erledigen.', 'ich habe heute viel zu erledigen'], correct: 'Ich habe heute viel zu erledigen.', explanation: 'haben + zu: Ich habe … zu erledigen.' },
    { type: 'translate', category: '🇷🇴 Traducere', question: 'Traduceți (sein zu):', ro: 'Formularul trebuie completat.', accept: ['das formular ist auszufüllen.', 'das formular ist auszufuellen'], correct: 'Das Formular ist auszufüllen.', explanation: 'sein + zu (pasiv), separabil: auszufüllen.' }
];
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            <h3>🎯 Test Final — Atelier haben/sein + zu + Infinitiv</h3>
            <p>Test cu <strong>${finalTestData.length} întrebări</strong>: haben + zu (activ) + sein + zu (pasiv) + zu la separabile + transformări müssen + traducere.</p>
            <ul class="test-info-list">
                <li>🔵 haben+zu (3) · 🟢 sein+zu (4) · 🔧 zu separabile (3) · 🔄 Transformări (3) · 🇷🇴 Traducere (2)</li>
...
function finishTest() {
    ...
    if (percentage === 100) { emoji = '🏆'; badge = 'PERFEKT!'; message = 'Ausgezeichnet!'; messageRo = 'Performanță excelentă! haben/sein + zu stăpânit complet!'; }
    ...
    results.innerHTML = `
        ...
        <div class="test-result-card ${passed ? 'passed' : 'failed'}">
            ...
            ${passed ? '<div class="pass-mark">✓ Atelier trecut (70%+)! 🔧 Acum stăpânești haben/sein + zu — obligație activă și necesitate/posibilitate pasivă.</div>' : '<div class="fail-mark">✗ Prag promovare: 70% (lipsesc ' + (Math.ceil(total * 0.7) - correct) + ' răspunsuri corecte)</div>'}
        </div>
        ${statsHTML}
        ${mistakesHTML}
